...
# Reorder games by brick folder addition time (oldest first):
...
# Build sections dynamically from the reordered games list
sections = [
    {
        "icon": "🔬",
        "title": "Histology",
